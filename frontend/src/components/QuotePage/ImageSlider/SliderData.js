...
export const SliderData = [
    {
      image:'covid.jpg',
      title: "Covid Tracker",
      message: "This tracker provides the cumulative number of confirmed COVID-19 cases and deaths, as well as the rate of daily COVID-19 cases and deaths in India and its states. This tracker will be updated regularly, as new data are released."
    },
    {
      image:'notes.jpg',
      title: "Keep Notes",
      message: "A color co-ordinated note-taking service provided free,with date and time tracking. The notes will be encrypted and can only be read by you."
    },
    {
      image:'news.jpg',
      title: "Trending News",
